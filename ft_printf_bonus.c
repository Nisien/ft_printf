...
/*   Updated: 2023/03/24 19:55:10 by nrossa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libftprintf_bonus.h"

int	ft_catch_widot(const char *str, t_flags *flags, va_list args)
{
	int	i;
...
void	ft_catch(const char *str, t_flags *flags, va_list args)
{
	int	i;
...
int	ft_dispatch(va_list args, t_flags flags)
{
	int	count;
...
int	ft_catch_and_dispatch(va_list args, const char *str)
{
	int		count;
	t_flags	flags;
